...
export default function AIGiftFinder() {
  ...
  return (
    <section id="ai-finder" style={{ background: "white", borderRadius: 16, padding: "40px 32px", boxShadow: "0 2px 16px rgba(0,0,0,0.06)", border: "1px solid #E2E8F0" }}>

      {/* Header */}
      <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16, flexWrap: "wrap", marginBottom: open || results ? 32 : 0 }}>
        <div>
        ...
        <>
          <form onSubmit={handleSubmit}>
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(200px, 1fr))", gap: 16 }}>
              ...
              <Field label="Gender">
                <select value={form.recipientGender} onChange={(e) => set("recipientGender", e.target.value)} style={inputStyle}>
              ...
              <Field label="Country">
                <input
                  type="text" placeholder="e.g. Lebanon"
                  value={form.country}
              ...
              <Field label="Occasion">
                <select value={form.occasion} onChange={(e) => set("occasion", e.target.value)} style={inputStyle}>
              ...
              <Field label="Interests / Hobbies" style={{ gridColumn: "1 / -1" }}>
                <input
                  type="text"
...
function Field({
  ...
  return (
    <div style={style}>
      <label style={{ display: "block", fontSize: 12, fontWeight: 600, color: "#475569", marginBottom: 6, letterSpacing: "0.05em", textTransform: "uppercase" }}>
        {label}
      </label>
      {children}
    </div>

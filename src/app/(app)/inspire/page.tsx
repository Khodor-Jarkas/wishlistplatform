...
// Lazy-load — AI Gift Finder is below the fold and many visitors never scroll to it.
const AIGiftFinder = dynamic(() => import("@/components/inspire/AIGiftFinder"))
  ...
  return (
    <>
      <main style={{ minHeight: "100vh", background: "#F8FAFC", paddingBottom: 80 }}>
        ...
        {/* Hero */}
        <div className="inspire-hero" style={{
